...
process_state_file_paths[`${PROCESS_STATES.ready_to_start}`] =
  DEVICES_READY_START_PATH;
process_state_file_paths[`${PROCESS_STATES.ready_to_finish}`] =
  DEVICES_READY_FINISH_PATH;
